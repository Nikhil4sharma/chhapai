-- Migration to FORCE 'pending' payment status in import_wc_order (User Request)
...
BEGIN
  ...
  -- FORCE 'pending' to match manual import behavior as per user request.
  -- Ignore whatever WC sends unless we decide otherwise later.
